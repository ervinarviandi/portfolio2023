    ...
    <>
      ...
      <div className="px-4 py-12">
        <section className="mt-[96px] mx-auto md:max-w-4xl xl:max-w-4xl px-4 ">
          <h1 className="dark:text-white text-3xl mb-10 font-poppins font-bold">🍌Nugget Landing Pages</h1>
          ...
          <div className="flex items-center space-x-5">
            <div className="flex items-center dark:text-white">
              <Link href="https://github.com/ervinarviandi/Slicing-Landing-Page-Nugget" className="flex items-center space-x-3 border-b-2 border-dashed  hover:text-pink-500 font-bold py-2">
                <BsGithub />
                <h4>Repository</h4>
              </Link>
            </div>
            <div className="flex items-center dark:text-white">
              <Link href="https://slicing-landing-page-nugget.vercel.app/" className="flex items-center space-x-3 hover:text-pink-500  border-b-2 py-2 border-dashed  dark:hover:text-pink-500 font-bold">
                <BsGlobe2 />
                <h4>Live Demo</h4>
              </Link>
            </div>
          ...
          <div className="flex justify-between ">
            <div className="">
              <a href="https://github.com/ervinarviandi/Slicing-Landing-Page-Nugget" className=" flex items-center space-x-4 dark:text-white font-bold font-poppins border-b-2 py-2 border-dashed   font-bold">
                <FaEdit />
