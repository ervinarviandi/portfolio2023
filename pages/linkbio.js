        ...
        <section className="mt-[96px] mx-auto md:max-w-3xl xl:max-w-3xl ">
          ...
          <div className="flex items-center space-x-5">
            <div className="flex items-center text-white">
              <Link href="" className="flex items-center space-x-3 border-b-2 border-dashed  hover:text-pink-500 font-bold py-2">
                <BsGithub />
                <h4>Repository</h4>
              </Link>
            </div>
            <div className="flex items-center text-white">
              <Link href="" className="flex items-center space-x-3 hover:text-pink-500  border-b-2 py-2 border-dashed  hover:text-pink-500 font-bold">
                <BsGlobe2 />
                <h4>Live Demo</h4>
              </Link>
            </div>
