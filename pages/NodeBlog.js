          ...
          <div className="w-full self-center px-4">
            ...
            <div className="rounded-md overflow-hidden">
              <div className="flex flex-col">
                ...
                <img src="https://www.hostinger.co.id/tutorial/wp-content/uploads/sites/11/2022/06/node.js-di-windows.webp" className="mt-4" width="600" />
                ...
                <img src="https://www.hostinger.co.id/tutorial/wp-content/uploads/sites/11/2022/06/folder-tujuan-node.js-di-windows.webp" className="mt-4" alt="gambar2" width="600" />

                <p className="text-base dark:text-white text-gray-700 font-poppins mt-20">
                  5. Pilih fitur yang akan diinstal. Kalau tidak yakin, biarkan nilai defaultnya. Klik <span>Next</span> .
                </p>
                <img src="https://www.hostinger.co.id/tutorial/wp-content/uploads/sites/11/2022/06/setup-node.js-kustom-di-windows.webp" className="mt-4" alt="gambar3" width="600" />

                <p className="text-base dark:text-white text-gray-700 font-poppins mt-20">
                  6. Install dependencies, dengan mencentang <span className="font-bold">Automatically install the necessary tools</span>.
                </p>
                <img src="https://hkalabs.com/wp-content/uploads/2021/04/6installDependensi-1.png" className="mt-4" alt="gambar4" width="600" />

                <p className="text-base dark:text-white text-gray-700 font-poppins mt-20">
                  7. Klik <span className="font-bold">install</span> untuk memulai instalasi
                </p>
                <img src="https://hkalabs.com/wp-content/uploads/2021/04/7install.png" className="mt-4" alt="gambar5" width="600" />
                ...
                <img src="https://hkalabs.com/wp-content/uploads/2021/04/9instalasiSelesai.png" className="mt-4" alt="gambar6" width="600" />

                <p className="text-base dark:text-white text-gray-700 font-poppins mt-20">
                  9. Tahap instalasi selanjutnya akan berlanjut secara otomatis di <span className="font-bold">Windows PowerShell</span>{" "}
                </p>
                <img src="https://hkalabs.com/wp-content/uploads/2021/04/10instalasiDependensi.png" className="mt-4" alt="gambar7" width="600" />
                ...
                <img src="https://hkalabs.com/wp-content/uploads/2021/04/11instalasiDependensiSelesai.png" className="mt-4" alt="gambar8" width="600" />
                ...
                <img src="nodev.jpg" className="mt-4" alt="gambar9" />
              </div>
            </div>
          </div>
        </section>
