    ...
    <>
      <main className="px-4 py-12 articles">
        <section className="mt-[96px] mx-auto md:max-w-4xl  xl:max-w-4xl px-4 border-gradient ">
          ...
          <p className="dark:text-primary10 text-gray-700 font-poppins text-base" data-aos="fade-up">
          ...
          <div className=" mt-[30px] ">
            <p className=" flex items-center dark:text-primary10 text-gray-700  hover:font-bold font-poppins" data-aos="fade-up">
              <Link href="/MyBlog" className="flex items-center  dark:hover:text-gradient200 hover:font-bold font-poppins">
                See All Post
                <BsFillArrowRightCircleFill className="ml-5 dark:text-primary10 text-gray-700 text-2xl dark:hover:text-gradient200 group" />
              </Link>
            </p>
          </div>
        </section>
