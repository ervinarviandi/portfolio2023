...
class CursorClass {
  ...
  render() {
    ...
    // lerp
    this.cursorConfigs.x.previous = lerp(this.cursorConfigs.x.previous, this.cursorConfigs.x.current, this.cursorConfigs.x.amt);

    this.cursorConfigs.y.previous = lerp(this.cursorConfigs.y.previous, this.cursorConfigs.y.current, this.cursorConfigs.y.amt);
