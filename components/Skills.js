          ...
          <div className="grid md:grid-cols-4 gap-4 ">
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-9xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45">HTML</h1>
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-9xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45">CSS</h1>
                <div className="px-4 pt-4">
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-8xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45 -mt-50">JAVASCRIPT</h1>
                <div className="px-4 pt-4">
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-7xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45 text-center">BOOTSTRAP</h1>
                <div className="px-4 pt-4">
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-9xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45 text-center -mt-60">TailwindCSS</h1>
                <div className="px-4 pt-4">
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-9xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45 text-center -mt-50">REACT</h1>
                <div className="px-4 pt-4">
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-9xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45 text-center -mt-50">NEXTJS</h1>
                <div className="px-4 pt-4">
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-9xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45 text-center -mt-80 -ml-20">CODEIGNITER</h1>
                <div className="px-4 pt-4">
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-9xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45 text-center -ml-20">FRAMER MOTION</h1>
                <div className="px-4 pt-4">
            ...
            <div className="flex flex-col">
              <div className="dark:bg-gray-800 bg-gray-300 p-2 rounded-lg border-t-2 border-t-blue-500 relative overflow-hidden">
                ...
                <h1 className="text-9xl absolute -z-4 dark:text-gray-900/50 text-white/50 font-extrabold -rotate-45 text-center -ml-20">TYPESCRIPT</h1>
                <div className="px-4 pt-4">
