    ...
    <>
      <main className="px-4 py-12">
        <section className="mt-[96px] mx-auto md:max-w-4xl  xl:max-w-4xl px-4">
          <div className="mb-10">
            <h2 className=" text-3xl  font-poppins font-extrabold md:text-7xl text-transparent bg-clip-text  bg-gradient-to-r  from-gradient100  to-gradient200 before:relative before:inset-0 before:bg-gradient-to-r before:from-pink-500  before:to-blue-500 ">
              Tools / Tech stack
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-4 ">
            <div className="flex flex-col">
              <div className="dark:bg-card100 bg-card200 p-2 rounded-lg border-t-2 border-t-gradient100 relative overflow-hidden">
