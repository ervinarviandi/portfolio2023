    ...
    <>
      <div>
        <section className="mt-[96px] mx-auto md:max-w-3xl  xl:max-w-3xl px-4">
          <h1 className="mb-1 md:mb-3 text-white text-3xl">Featured Portfolio</h1>
          <p className="mb-6 md:mb-8 text-white">Check out my featured portfolio, feel free to explore it.</p>
            ...
            <div className="flex flex-col">
              <div className="rounded-md overflow-hidden  ">
                ...
                <div className="mt-3">
                  ...
                  <p className="text-white">A landing page of a Schedule App. Its also a Dicoding Submission Project for Learn Basic of Web Programming class.</p>
                </div>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="rounded-md overflow-hidden ">
                ...
                <div className="mt-3">
                  <h3 className="text-white font-bold border-b-2 border-dashed border-transparent">
                    <a className="hover:border-b-2 hover:border-dashed" href="">
                      {" "}
                      Expense App
                    </a>
                  ...
                  <p className="text-white">ExpenseApp is an app to see you expense history, income history and help you notes what youre buying lately💰</p>
                </div>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="rounded-md overflow-hidden ">
                ...
                <div className="mt-3">
                  ...
                  <p className="text-white">React Link is an app to see you expense history, income history and help you notes what youre buying lately🔗</p>
                </div>
              </div>
            </div>
          </div>
          <div className=" mt-[30px] ">
            <p className=" flex items-center text-white hover:text-pink-500 hover:font-bold">
